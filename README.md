...
## Requirements
Please note download [LLaMA-Factory-files](https://github.com/hiyouga/LLaMA-Factory/releases/tag/v0.5.3) first and unzip it to prepare environments.
1. mv MACPO/* LLaMA-Factory-main/
2. pip install -e .
3. if you encounter errors about the environment, you can use pip install -r requirements.txt to fix it.
